        ...
        <div className={styles.userInfo}>
          {userData ? (
            <>
              ...
              <p><strong>Alergie:</strong> {userData.allergiesInfo}</p>
              <p><strong>Leki:</strong> {userData.medicationsInfo}</p>
              <p><strong>Choroby przewlekłe:</strong> {userData.diseasesInfo}</p>
            </>
          ) : (
